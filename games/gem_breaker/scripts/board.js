...
var chains = getChains(), hadChains = false, score = 0, removed = [], moved = [], gaps = [];
...
// returns true if (x, y) is a valid position and if the jewel at (x, y) can be swapped with a neighbor
function canJewelMove(x, y) {
return ((x > 0 && canSwap(x, y, x-1, y)) || (x < cols-1 && canSwap(x, y, x+1, y)) || (y > 0 && canSwap(x, y, x, y-1)) || (y < rows-1 && canSwap(x, y, x, y+1)));
}
