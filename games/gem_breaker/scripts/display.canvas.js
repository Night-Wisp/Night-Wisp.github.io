jewel.useCanvasDisplay = function() {
jewel.display = (function() {
var paused, jewels, jewelSprite, canvas, ctx, cols, rows, jewelSize, firstRun = true, cursor, previousCycle, animations = [];
