...
var inputHandlers, gpStates, gpPoller;

function initialize() {
var dom = jewel.dom, $ = dom.$, controls = jewel.settings.controls, board = $("#game-screen .game-board") [0];
...
gamepadAxisChange(gamepad, i, state.axes[1]);
}
}
}
...
var settings = jewel.settings, action = settings.controls[control];
if (!action) {
return;
}
