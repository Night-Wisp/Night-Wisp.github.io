...
var paused, pauseStart, firstRun = true, cursor, gameState;
...
var activeGame = jewel.storage.get("activeGameData"), useActiveGame, startJewels;
...
paused = false;
var dom = jewel.dom, overlay = dom.$("#game-screen .pause-overlay") [0];
...
function setup() {
var dom = jewel.dom, input = jewel.input;
